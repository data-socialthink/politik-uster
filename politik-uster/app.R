...
#Namensänderung Claudia Wyssen --> Claudia Frei
Geschafte_Liste$Geschäft <- str_replace_all(Geschafte_Liste$Geschäft, "Claudia Wyssen", "Claudia Frei")
                                    ...
                                    fluidRow(
                                        column(3,HTML("<br>"),wellPanel(
                                            ...
                                            radioButtons("radio_sna_legislatur", "Zeitraum",
                                                         choices = list("Legislatur 2022-2026" = 1,
                                                                        "Legislatur 2018-2022" = 2,
                                                                        "Legislatur 2014-2018" = 3,
                                                                        "Legislatur 2010-2014" = 4,
                                                                        "sonstiger Zeitraum:" = 5),selected = 1),
...
server <- function(input, output) {
    ...
    output$plot_sna <- renderCachedPlot({
        ...
        if (input$radio_sna_legislatur == 1) {
            datum_von <- as.Date("2022-05-09")
            datum_bis <- as.Date("2026-05-08")
        ...
        } else if (input$radio_sna_legislatur == 5){
